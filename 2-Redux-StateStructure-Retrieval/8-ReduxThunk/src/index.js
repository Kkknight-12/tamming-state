...
function doAddTodoWithNotification( id, name ){
  // just like before we are calling doAddTodo function but we are calling through doAddTodoWithNotification
  return function ( dispatch ){
    dispatch( doAddTodo( id, name ));

    // after 5 sec you dispatch action function which will hide the notification
    setTimeout( function ( ){
